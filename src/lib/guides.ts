/* The index of everything on the site that walks you through something.
   Lives here rather than on a page because two surfaces consume it:
   /tutorials (the front door) and the ladder hub.
